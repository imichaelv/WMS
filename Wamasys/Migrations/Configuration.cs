...
namespace Wamasys.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Wamasys.ApplicationDbContext>
    {
        ...
        {
            if (context.Status.FirstOrDefault(row => row.Name == "New Order") == null)
            {
            ...
            if (!context.Users.Any())
            {
                ...
                var user1 = new ApplicationUser
                {
                    FirstName = "Michael",
                    LastName = "Jansen",
                    Email = "spammich@live.nl",
                    EmailConfirmed = true,
                    UserName = "spammich@live.nl",
                    AccessFailedCount = 0
                };
                var user2 = new ApplicationUser
                {
                    FirstName = "Joost",
                    LastName = "de Grote",
                    Email = "pipodeclown@st.hanze.nl",
                    EmailConfirmed = true,
                    UserName = "pipodeclown@st.hanze.nl",
                    AccessFailedCount = 0
                };
                var user3 = new ApplicationUser
                {
                    FirstName = "Leon",
                    LastName = "Wetzel",
                    Email = "leonw@st.hanze.nl",
                    EmailConfirmed = true,
                    UserName = "leonw@st.hanze.nl",
                    AccessFailedCount = 0
                };
                var user4 = new ApplicationUser
                {
                    FirstName = "Leonie",
                    LastName = "Wetzel",
                    Email = "leoniew@st.hanze.nl",
                    EmailConfirmed = true,
                    UserName = "leoniew@st.hanze.nl",
                    AccessFailedCount = 0
                };
                var user5 = new ApplicationUser
                {
                    FirstName = "Jorgen",
                    LastName = "Goos",
                    Email = "jorgen.goos@getthere.com",
                    EmailConfirmed = true,
                    UserName = "jorgen.goos@getthere.com",
                    AccessFailedCount = 0
                };
            ...
            if (context.Building.FirstOrDefault(row => row.Name == "Van DerksVeste") == null)
            {
            ...
            if (!context.Gantry.Any())
            {
                ...
                {
                    gantryList.Add(new Gantry
                    {
                        Name = j.ToString() + _alphabet[_rand.Next(_alphabet.Length)],
                        Limit = _rand.Next(2000) + 1000,
                        XCoordinate = _rand.Next(1000, 10000),
                        YCoordinate = _rand.Next(1000, 4000),
                        ZCoordinate = _rand.Next(1, 5)
                    });
                }
